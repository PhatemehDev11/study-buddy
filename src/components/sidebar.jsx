...
const recentChats = [
  ...
  <Brain size={20} strokeWidth={1.8} />
        ...
        {/* New Chat */}
        <button className="mb-7 flex w-full items-center justify-center gap-2 rounded-xl bg-white px-4 py-3 text-sm font-medium text-black transition hover:bg-zinc-200">
